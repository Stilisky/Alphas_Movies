...
const {categoryToMovie, commentToMovie, favoriteToUser, genreToMovies, likeToMovie, movieToCategory, moviesToGenre, createcommentAndAddToMovie} = require('../controllers/appController')

...
export default function Feature() {
  return (
    <section className='bg-black h-auto'>
      <div className='relative pt-24  text-bold'>
        <h2 className=' text-gray-500 text-xl text-center '> Critically Acclaimed Titles</h2>
        <h1 className=' text-5xl text-white text-center text-bold mt-10 mb-4 uppercase'>Find all the movies you love </h1>
      </div>

      <div class="grid grid-cols-1 md:grid-cols-3 justify-center items-center container mx-auto">
        <div class="p-8">
          <div
          ...
          <p class="font-light text-sm text-gray-500 mb-3">
            Join a free open community and begin to express yourself. Find like minded people and link up.
          </p>
        ...
        <div class="p-8">
          ...
          <p class="font-light text-sm text-gray-500 mb-3">
            Speak freely and give you opinions through a system of like and dislike.
          </p>
        ...
        <div class="p-8">
          ...
          <p class="font-light text-sm text-gray-500 mb-3">
            Visit our website for an extensive list of all movies, premiere dates and production details.
          </p>
      ...
      <div class=" flex mx-auto justify-center ml-5 mr-4 space-x-6">
        <div class=" max-w-sm bg-cover h-[600px] w-1/2 pl-6 custom-spider"></div>
        <div className='w-1/2 mt-[300px] mr-12'>
          ...
          <p className='text-white text-xl'>Search movies, express your opinions and leave critics on your favorite movies. Join the community and get started. </p>
          <a href='/'><p className='text-[#1ce783] text-l'>See What Critics Are Saying</p></a>
        </div>
      </div>
    </section>

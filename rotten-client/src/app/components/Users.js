            ...
            <div className="w-full lg:w-5/6">
               <div className='w-full'>
                  <div class="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                     <button onClick={handleOpenModal} class="bg-[#14472C] text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-2 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">
                        Create User
                     </button>
                  </div>
               </div>
               <UserModal isOpen={modalOpen} onClose={onClose} onCreate={onCreate} />
                  ...
                  <table className="min-w-max w-full table-auto">
                     ...
                     <tbody className="text-gray-600 text-sm font-light">
                           ...
                           <tr className="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                              ...
                              <td className="py-3 px-6 text-left">
                                 <div className="flex items-center">
                                       <span className="font-medium">mail@mail.com</span>
                                 </div>
                              </td>
                              <td className="py-3 px-6 text-center">
                                 <span className="bg-green-200 text-green-600 py-1 px-3 rounded-full text-xs">Admin</span>
                              </td>
                              <td className="py-3 px-6 text-center">

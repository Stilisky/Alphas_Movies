...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/map/login", {
        method: "POST",
        headers: {
  ...
  <path fill-rule="evenodd" d="M5.47 5.47a.75.75 0 011.06 0L12 10.94l5.47-5.47a.75.75 0 111.06 1.06L13.06 12l5.47 5.47a.75.75 0 11-1.06 1.06L12 13.06l-5.47 5.47a.75.75 0 01-1.06-1.06L10.94 12 5.47 6.53a.75.75 0 010-1.06z" clip-rule="evenodd" />
              ...
              <form class="space-y-4 md:space-y-6" onSubmit={handleLogin}>
                <div>
                  {error && (
                    <p className="text-red-500 mb-2 text-center Email text-sm">
                      {error}
                    </p>
                  )}
                  <label
                  ...
                  <input
                    ...
                    name="email"
                    id="email"
                    class="bg-gonChange={handleChange}ray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
